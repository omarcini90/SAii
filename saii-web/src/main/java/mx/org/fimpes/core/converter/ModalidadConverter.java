...
public class ModalidadConverter implements Converter<Modalidad> {
    ...
    @Override
    public Modalidad getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        return controller.getModalidadById(getKey(value));
    }
    ...
    @Override
    public String getAsString(FacesContext facesContext, UIComponent component, Modalidad object) {
        if (object == null) {
            return null;
        }
        return getStringKey(object.getIdModalidad());
    }
